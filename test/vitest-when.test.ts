...
describe('vitest-when', () => {
  ...
  it('should debug a non-stubbed spy', () => {
    const spy = vi.fn()

    const result = subject.debug(spy, { log: false })
  ...
  it('debugs the name of a spy', () => {
    const spy = vi.fn().mockName('harry')
  ...
  it('debugs called stubbings', () => {
    ...
    const result = subject.debug(spy, { log: true })
